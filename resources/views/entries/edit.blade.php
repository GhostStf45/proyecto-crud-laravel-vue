                    ...
                    <form action="{{ url('entries/'.$entry->id) }}" method="post">
                        ...
                        <div class="form-group ">
                            <label for="content" >Content</label>
                                <textarea id="content" type="content" class="form-control @error('content') is-invalid @enderror" name="content" required autocomplete="content">{{ old('content', $entry->content) }} </textarea>
